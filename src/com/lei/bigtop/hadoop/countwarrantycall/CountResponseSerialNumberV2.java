...
/*
hadoop fs -put ~/Documents/workspace/HadoopSample/conf/WarrantyDataCount.properties /warranty/conf

hadoop fs -mkdir /warranty/data

hadoop fs -put /Users/lei/AppleDoc/Project_Warranty/Data/hadoopdata/* /warranty/data

hadoop fs -ls /warranty/data

hadoop jar /Users/lei/Documents/workspace/HadoopV2/target/release/HadoopV2.jar com.abc.hadoop.CountResponseSerialNumberV2 -DSVC_NAME=Warranty -Dmain.config.file="/Users/lei/Documents/workspace/HadoopSample/conf/WarrantyDataCount.properties" /warranty/data /output6

 */
public class CountResponseSerialNumberV2 extends Configured implements Tool {
	
	static private String CountResponseSerialNumberV2_SVC_NAME = "";
	static private String CountResponseSerialNumberV2_PROPERTY_File = "";
	...
	public static class Map extends MapReduceBase implements Mapper<LongWritable, Text, Text, WarrantyAuditDataCount> { 
		...
		public void configure(JobConf job) {
			...
			if (SVC_NAME==null) {
				SVC_NAME = CountResponseSerialNumberV2_SVC_NAME;
			}
			...
			if (propFile==null) {
				propFile = CountResponseSerialNumberV2_PROPERTY_File;
			}
	...
	public int run(String[] args) throws Exception {
		...
		conf.setJobName("CountResponseSerialNumberV2");
		...
		if (args.length >2) {
			CountResponseSerialNumberV2_SVC_NAME = args[2];	
		}
		if (args.length >3) {
			CountResponseSerialNumberV2_PROPERTY_File = args[3];	
		}
