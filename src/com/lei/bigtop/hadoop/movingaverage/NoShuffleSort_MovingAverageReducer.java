...
public class NoShuffleSort_MovingAverageReducer extends MapReduceBase implements
	...
	public void reduce(Text key, Iterator<TimeseriesDataPoint> values,
		...
		int iWindowSizeInDays = this.configuration.getInt("hadoop.movingaverage.windowSize", 30);
		int iWindowStepSizeInDays = this.configuration.getInt("tv.floe.caduceus.hadoop.movingaverage.windowStepSize", 1);
